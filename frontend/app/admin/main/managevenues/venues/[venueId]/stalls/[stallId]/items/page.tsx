      ...
      <div className="flex-1 w-full">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-bold text-2xl">{stallName}</h1>
          </div>
                ...
                <section key={cat.category_id} className="rounded-2xl bg-white p-5 shadow-sm">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <button className="rounded-md p-1 hover:bg-gray-100" aria-label="Edit category">
                        <Pencil className="h-4 w-4 opacity-70" />
                      </button>
                    </div>

                    <Button variant="addstall" onClick={() => handleOpenCreateItem(cat.category_id)}>
                      <CirclePlus />
                      Add Item
                    </Button>
                  </div>
